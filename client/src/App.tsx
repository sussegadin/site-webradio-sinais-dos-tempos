...
function Router(){return <Switch><Route path="/" component={Home}/><Route path="/blog" component={Blog}/><Route path="/post/:slug" component={Post}/><Route path="/sponsors" component={Sponsors}/><Route path="/louvores" component={Louvores}/><Route path="/admin" component={AdminEntryRoute}/><Route path="/admin/login" component={AdminLoginRoute}/><Route path="/login" component={EditorLoginRoute}/><Route path="/admin/painel" component={AdminDashboard}/><Route path="/admin/layout" component={LegacyLayoutRoute}/><Route path="/admin/editor" component={EditorRoute}/><Route path="/admin/programacao" component={ProgrammingAdminRoute}/><Route path="/admin/louvores" component={LouvoresAdmin}/><Route path="/admin/patrocinadores" component={SponsorsAdmin}/><Route path="/admin/avisos" component={AnnouncementsAdmin}/><Route path="/admin/redes-sociais" component={SiteContentAdmin}/><Route path="/admin/textos" component={SiteContentAdmin}/><Route path="/admin/testemunhos" component={TestimonialsAdmin}/><Route component={NotFound}/></Switch>}
