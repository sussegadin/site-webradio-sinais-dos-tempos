...
export default function SiteShell({ children }: { children: ReactNode }) {
  ...
  const { data: visitCounter } = useQuery<{ count: number; today: number }>({ queryKey: ['visit-counter'], queryFn: () => apiFetch('/api/visits'), staleTime: Infinity, refetchOnWindowFocus: false, refetchOnReconnect: false, retry: false });
